...
tc filter add dev wlan0 protocol ip parent 1: prio 1 u32 match ip sport 443 0xffff flowid 1:2
tc filter add dev wlan0 protocol ip parent 1: prio 1 u32 match ip sport 80 0xffff flowid 1:2
